 ...
 <div class="body1">
        <div class="container1">
            ...
            <div class="slider">
                ...
                <div class="text1">
                    <h2>Orenexa — Inspired by Roots, Styled by You</h2>
                    <p>Where heritage meets modern expression</p>
                </div>
            ...
            <div class="feature_box">
                ...
                <div class="feature_img">
                    <img class="right" src="../picture/ring.png">
                </div>

                <div class="feature_text">
                    <h2>Luxury Rings</h2>
                    <p>Crafted with precision & elegance for modern style.</p>
                    <button>Explore</button>
                </div>

            </div>

            <div class="feature_box reverse">

                <div class="feature_img">
                    <img class="left" src="../picture/newari_girl.png">
                </div>

                <div class="feature_text">
                    <h2>Heritage Collection</h2>
                    <p>Inspired by tradition, culture, and timeless beauty.</p>
